...
enum 
{
    ...
    RFAL_NFCV_CMD_EXTENDED_WRITE_MULTIPLE_BLOCK = 0x34,      /*!< Extended read multiple block command                         */
    RFAL_NFCV_CMD_EXTENDED_GET_SYS_INFO         = 0x3B       /*!< Extended Get System Information command                      */
};
 ...
 *  
 * Reads Multiple Blocks from a device (VICC)
 * In order to not limit the length of the Write muilple command, a buffer
