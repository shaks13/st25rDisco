...
#elif USE_USBCDC_STREAM_DRIVER == 1
...
#define UsbTransmit				CDC_Transmit_FS
#define	UsbTransmitReady		CDC_isTxBusy
#define UsbReceive				CDC_isRxframe
